        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-amber text-base font-[family-name:var(--font-space-grotesk)] text-[10px] uppercase tracking-[0.1em] font-bold px-4 py-2 hover:bg-amber-light transition-colors"
            >
