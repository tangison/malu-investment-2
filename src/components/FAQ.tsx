  ...
  return (
    <section ref={ref} className="bg-light border-y border-light-border py-16 sm:py-24">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="font-display text-[clamp(2rem,5vw,4rem)] text-light-text leading-[0.9] mb-10">
          COMMON QUESTIONS
        </h2>
        ...
        <div className="space-y-0">
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                <p className="font-[family-name:var(--font-space-grotesk)] text-sm text-light-text-secondary leading-relaxed pb-5">
                  {faq.a}
                </p>
              </motion.div>
            </motion.div>
