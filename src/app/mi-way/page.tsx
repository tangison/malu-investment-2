        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-6">
              <p className="font-[family-name:var(--font-space-grotesk)] text-base text-text-secondary leading-[1.8]">
              ...
              <div className="bg-base-card border border-base-border p-6">
                <h2 className="font-display text-xl text-text-primary mb-4">PLATFORM CAPABILITIES</h2>
